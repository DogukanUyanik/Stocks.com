// src/rest/index.ts
import type { KoaApplication, StockAppContext, StockAppState } from '../types/koa';
import Router from '@koa/router';
import installGebruikerRouter from './gebruiker';
import installHealthRouter from './health';
import installTransactionRouter from './transactie';
import installAandeelRouter from './aandelen';
